...
MessageId=1002 SymbolicName=MSG_WSL_UNREGISTER_DISTRIBUTION_FAILED
Language=English
WslUnRegisterDistribution failed with error: 0x%1!x!
.

MessageId=1003 SymbolicName=MSG_WSL_CONFIGURE_DISTRIBUTION_FAILED
Language=English
...
MessageId=1013 SymbolicName=MSG_MISSING_OPTIONAL_COMPONENT
Language=English
The Windows Subsystem for Linux optional component is not enabled. Please enable it and try again.
See https://aka.ms/wslinstall for details.
.

MessageId=1014 SymbolicName=MSG_INSTALL_ALREADY_EXISTS
Language=English
